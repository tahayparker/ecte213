...
for n_sim = 1:1:length(T_sim)
    ...
    % After calculating E_x1 and E_x2, add:
    max_E_x1 = max(abs(E_x1));
    max_E_x2 = max(abs(E_x2));
    max_E_total = max(max_E_x1, max_E_x2);
    fprintf('Maximum electric field magnitude: %f V/m\n', max_E_total);
