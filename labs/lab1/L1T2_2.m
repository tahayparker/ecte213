...
Q = 1;                              % Charge magnitude (-1 C)
epsilon0 = 8.85e-12;                % Permittivity of free space (F/m)
k = Q / (4 * pi * epsilon0);        % Coulomb's constant times charge
...
V0 = k ./ r0;                        % Potential due to charge 1
V1 = k ./ r1;                        % Potential due to charge 2
...
xlabel('Y'); 
ylabel('Z');
title('Electric Field of Q in YZ Plane');
grid on;
axis([-3 3 -3 3]);
